...
const eventsDefault = [new cardShapedThing("Advance", cardType.EVENT), new cardShapedThing("Alliance", cardType.EVENT), new cardShapedThing("Alms", cardType.EVENT), new cardShapedThing("Avoid", cardType.EVENT), new cardShapedThing("Banquet", cardType.EVENT), new cardShapedThing("Bonfire", cardType.EVENT), new cardShapedThing("Bury", cardType.EVENT), new cardShapedThing("Commerce", cardType.EVENT), new cardShapedThing("Delay", cardType.EVENT), new cardShapedThing("Deliver", cardType.EVENT), new cardShapedThing("Delve", cardType.EVENT), new cardShapedThing("Desperation", cardType.EVENT), new cardShapedThing("Enhance", cardType.EVENT), new cardShapedThing("Expedition", cardType.EVENT), new cardShapedThing("Gamble", cardType.EVENT), new cardShapedThing("Journey", cardType.EVENT), new cardShapedThing("Launch", cardType.EVENT),
new cardShapedThing("Maelstrom", cardType.EVENT), new cardShapedThing("March", cardType.EVENT), new cardShapedThing("Mirror", cardType.EVENT), new cardShapedThing("Mission", cardType.EVENT), new cardShapedThing("Populate", cardType.EVENT), new cardShapedThing("Prepare", cardType.EVENT), new cardShapedThing("Pursue", cardType.EVENT), new cardShapedThing("Quest", cardType.EVENT), new cardShapedThing("Reap", cardType.EVENT), new cardShapedThing("Save", cardType.EVENT), new cardShapedThing("Scouting_Party", cardType.EVENT), new cardShapedThing("Scrounge", cardType.EVENT), new cardShapedThing("Seize_the_Day", cardType.EVENT), new cardShapedThing("Summon", cardType.EVENT), new cardShapedThing("Toil", cardType.EVENT), new cardShapedThing("Trade", cardType.EVENT), new cardShapedThing("Travelling_Fair", cardType.EVENT), new cardShapedThing("Windfall", cardType.EVENT)]
const eventsDebtVictory = [new cardShapedThing("Triumph", cardType.EVENT), new cardShapedThing("Wedding", cardType.EVENT)]
const eventsDebt = [new cardShapedThing("Annex", cardType.EVENT), new cardShapedThing("Donate", cardType.EVENT), new cardShapedThing("Rush", cardType.EVENT), new cardShapedThing("Tax", cardType.EVENT)]
